...
const StatProfile = () => {
  ...
  // useEffect(() => {
  //   axios
  //     .get(`http://localhost:5555/api/auth/users/${id}`)
  //     .then((result) => {
  //       setData(result.data);
            ...
            <div className="col-span-4 sm:col-span-3">
                <div className=" bg-white bg-opacity-80 z-50 overlay shadow rounded-lg p-6">
                    <div className="flex flex-col items-center">
                        <img src={user.photoURL} className="w-32 h-32 bg-gray-300 rounded-full mb-4 shrink-0">
                    ...
                    <Link to="/editProfile" className="bg-green-500 hover:bg-green-600 text-white py-2 px-4 rounded">Edit  </Link>
                        </div>
                    </div>
