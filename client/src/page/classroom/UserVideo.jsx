...
const VideoCard = ({ participant, onClick }) => {
      ...
      <div className="absolute bottom-2 left-2 right-2 flex justify-between items-center">
        ...
        <div className="flex space-x-1">
          ...
          {participant.videoOff ? (
            ...
            <Video className="text-green-500 h-4 w-4" />
          )}
        </div>
      </div>
      <AnimatePresence>
        {isHovered && (
          ...
          >
            <BadgeInfo className="text-yellow-400 h-4 w-4" />
          </motion.div>
        )}
      </AnimatePresence>
    </motion.div>
    ...
    <Dialog open={!!participant} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>
            View information about {participant?.name}
          </DialogDescription>
        </DialogHeader>
            ...
            <div>
              ...
              <div className="flex items-center space-x-2">
                {participant?.muted ? (
                  ...
                  <Mic className="text-green-500 h-4 w-4" />
                )}
                {participant?.videoOff ? (
                  <VideoOff className="text-red-500 h-4 w-4" />
                ) : (
                ...
                {participant?.handRaised && (
                  <Hand className="text-yellow-400 h-4 w-4" />
                )}
              </div>
            </div>
          </div>
