...
export declare class Tuple implements flatbuffers.IUnpackableObject<TupleT> {
    ...
    static createTuple(builder: flatbuffers.Builder, localIpOffset: flatbuffers.Offset, localPort: number, remoteIpOffset: flatbuffers.Offset, remotePort: number, protocol: Protocol): flatbuffers.Offset;
    unpack(): TupleT;
...
export declare class TupleT implements flatbuffers.IGeneratedObject {
    ...
    remotePort: number;
    protocol: Protocol;
    constructor(localIp?: string | Uint8Array | null, localPort?: number, remoteIp?: string | Uint8Array | null, remotePort?: number, protocol?: Protocol);
