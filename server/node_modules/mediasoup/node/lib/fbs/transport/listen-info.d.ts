...
import { SocketFlags, SocketFlagsT } from '../../fbs/transport/socket-flags';
...
export declare class ListenInfoT implements flatbuffers.IGeneratedObject {
    ...
    sendBufferSize: number;
    recvBufferSize: number;
    constructor(protocol?: Protocol, ip?: string | Uint8Array | null, announcedIp?: string | Uint8Array | null, port?: number, flags?: SocketFlagsT | null, sendBufferSize?: number, recvBufferSize?: number);
