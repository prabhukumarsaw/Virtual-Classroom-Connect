...
class ListenInfo {
    ...
    unpack() {
        return new ListenInfoT(this.protocol(), this.ip(), this.announcedIp(), this.port(), (this.flags() !== null ? this.flags().unpack() : null), this.sendBufferSize(), this.recvBufferSize());
    }
    unpackTo(_o) {
...
class ListenInfoT {
    ...
    sendBufferSize;
    recvBufferSize;
    constructor(protocol = protocol_1.Protocol.UDP, ip = null, announcedIp = null, port = 0, flags = null, sendBufferSize = 0, recvBufferSize = 0) {
    ...
    pack(builder) {
        ...
        ListenInfo.addAnnouncedIp(builder, announcedIp);
