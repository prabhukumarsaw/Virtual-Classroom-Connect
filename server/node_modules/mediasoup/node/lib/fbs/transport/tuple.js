...
class Tuple {
    ...
    static createTuple(builder, localIpOffset, localPort, remoteIpOffset, remotePort, protocol) {
...
class TupleT {
    ...
    remotePort;
    protocol;
    constructor(localIp = null, localPort = 0, remoteIp = null, remotePort = 0, protocol = protocol_1.Protocol.UDP) {
    ...
    pack(builder) {
        ...
        return Tuple.createTuple(builder, localIp, this.localPort, remoteIp, this.remotePort, this.protocol);
    }
}
