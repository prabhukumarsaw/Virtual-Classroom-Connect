...
class IceCandidate {
    ...
    static createIceCandidate(builder, foundationOffset, priority, ipOffset, protocol, port, type, tcpType) {
...
class IceCandidateT {
    ...
    type;
    tcpType;
    constructor(foundation = null, priority = 0, ip = null, protocol = protocol_1.Protocol.UDP, port = 0, type = ice_candidate_type_1.IceCandidateType.HOST, tcpType = null) {
    ...
    pack(builder) {
        ...
        return IceCandidate.createIceCandidate(builder, foundation, this.priority, ip, this.protocol, this.port, this.type, this.tcpType);
    }
}
