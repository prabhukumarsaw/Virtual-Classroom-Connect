...
export declare class WebRtcTransportOptions implements flatbuffers.IUnpackableObject<WebRtcTransportOptionsT> {
    ...
    static createWebRtcTransportOptions(builder: flatbuffers.Builder, baseOffset: flatbuffers.Offset, listenType: Listen, listenOffset: flatbuffers.Offset, enableUdp: boolean, enableTcp: boolean, preferUdp: boolean, preferTcp: boolean): flatbuffers.Offset;
...
export declare class WebRtcTransportOptionsT implements flatbuffers.IGeneratedObject {
    ...
    preferUdp: boolean;
    preferTcp: boolean;
    constructor(base?: OptionsT | null, listenType?: Listen, listen?: ListenIndividualT | ListenServerT | null, enableUdp?: boolean, enableTcp?: boolean, preferUdp?: boolean, preferTcp?: boolean);
