...
export declare class IceCandidate implements flatbuffers.IUnpackableObject<IceCandidateT> {
    ...
    static createIceCandidate(builder: flatbuffers.Builder, foundationOffset: flatbuffers.Offset, priority: number, ipOffset: flatbuffers.Offset, protocol: Protocol, port: number, type: IceCandidateType, tcpType: IceCandidateTcpType | null): flatbuffers.Offset;
...
export declare class IceCandidateT implements flatbuffers.IGeneratedObject {
    ...
    type: IceCandidateType;
    tcpType: IceCandidateTcpType | null;
    constructor(foundation?: string | Uint8Array | null, priority?: number, ip?: string | Uint8Array | null, protocol?: Protocol, port?: number, type?: IceCandidateType, tcpType?: IceCandidateTcpType | null);
